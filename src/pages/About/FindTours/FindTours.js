    ...
    <div className="container py-5">
      <div className="row find-tour">
        <div className="col-lg-6 col-sm-12 mb-3">
          ...
          <ul>
            <li> <GoPrimitiveDot className="color-green "/> of additional materials or parts (if needed)</li>
            <li><GoPrimitiveDot className="color-green "/>Transportation cost for carrying new materials/parts</li>
          </ul>
